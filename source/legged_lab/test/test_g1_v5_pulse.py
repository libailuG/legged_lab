"""v5 low-speed authority, plateau/release, state isolation and encoder bias checks."""
import ast
...
BASE=ROOT/'source/legged_lab/legged_lab/tasks/locomotion/amp/config/g1_assist_exoskeleton_v2_v5/mdp'
...
class V5Tests(unittest.TestCase):
    ...
    def test_completed_pulse_feedback_includes_zero_output(self):
        ...
        # Lift=0.3 -> smoothstep(0.5)=0.5 -> target=4.75 Nm.
        zero,log,reward=evaluate(0.,True)
        matched,_,_=evaluate(4.75,True)
