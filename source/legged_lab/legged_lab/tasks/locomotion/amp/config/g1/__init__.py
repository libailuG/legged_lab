...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-v1",
    entry_point="legged_lab.envs:ManagerBasedAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.g1_amp_env_cfg:G1AmpEnvCfgV1",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1V1RslRlOnPolicyRunnerAmpCfg",
    },
)
...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-Play-v1",
    entry_point="legged_lab.envs:ManagerBasedAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.g1_amp_env_cfg:G1AmpEnvCfg_PLAY_V1",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1V1RslRlOnPolicyRunnerAmpCfg",
    },
)
