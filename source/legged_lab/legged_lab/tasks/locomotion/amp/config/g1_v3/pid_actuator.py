"""Explicit joint PID actuator used only by the G1 AMP v3 task."""
...
class IdealPIDActuator(IdealPDActuator):
    ...
    The integral torque is updated once per physics step and clamped directly
    in N m. Integration is rejected when actuator saturation would be driven
