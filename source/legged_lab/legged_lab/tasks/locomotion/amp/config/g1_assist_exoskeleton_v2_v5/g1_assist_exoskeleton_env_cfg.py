...
class AssistRewardsCfg:
    ...
    assist_completed_pulse_peak = RewTerm(
        func=mdp.CompletedPulsePeakReward, weight=-4.0,
...
@configclass
class G1AssistExoskeletonV2V5EnvCfg(G1AssistAmpEnvCfg):
    """Train v2-v5 with -10 Nm lift and +10 Nm press authority."""
...
@configclass
class G1AssistExoskeletonV2V5EnvCfg_PLAY(G1AssistExoskeletonV2V5EnvCfg):
    """Play configuration for the asymmetric v2-v5 assist policy."""
