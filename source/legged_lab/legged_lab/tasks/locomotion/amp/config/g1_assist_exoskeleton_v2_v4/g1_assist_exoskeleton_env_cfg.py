...
class AssistActionsCfg:
    """One policy amplitude is latched at the start of each smooth paired pulse."""
...
@configclass
class G1AssistExoskeletonV2V4EnvCfg(G1AssistAmpEnvCfg):
    """Train v2-v4 with -10 Nm lift and +10 Nm press authority."""
...
@configclass
class G1AssistExoskeletonV2V4EnvCfg_PLAY(G1AssistExoskeletonV2V4EnvCfg):
    """Play configuration for the asymmetric v2-v4 assist policy."""
