"""PPO for v4: 400 local/controller actor inputs and one latched pulse amplitude."""
...
@configclass
class G1AssistExoskeletonV2V4PPORunnerCfg(RslRlOnPolicyRunnerCfg):
    class_name = "OnPolicyRunner"
    num_steps_per_env = 48
    max_iterations = 10000
    save_interval = 100
    experiment_name = "g1_assist_exoskeleton_v2_v4_ppo"
    obs_groups = {"policy": ["policy"], "critic": ["critic"]}
    clip_actions = 1.0

    policy = RslRlPpoActorCriticCfg(
        init_noise_std=0.2,
        # One trainable exploration standard deviation for pulse amplitude.
