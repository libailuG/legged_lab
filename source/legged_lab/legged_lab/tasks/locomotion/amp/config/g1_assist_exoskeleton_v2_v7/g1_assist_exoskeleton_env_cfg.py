...
@configclass
class G1AssistExoskeletonV2V7EnvCfg(G1AssistAmpEnvCfg):
    """Train v2-v7 with -10 Nm lift and +10 Nm press authority."""
...
@configclass
class G1AssistExoskeletonV2V7EnvCfg_PLAY(G1AssistExoskeletonV2V7EnvCfg):
    """Play configuration for the asymmetric v2-v7 assist policy."""
