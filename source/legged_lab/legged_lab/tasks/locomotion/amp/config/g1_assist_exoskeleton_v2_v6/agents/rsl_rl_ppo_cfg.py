"""PPO for v6: 450 actor inputs and latched peak/duration actions."""
...
@configclass
class G1AssistExoskeletonV2V6PPORunnerCfg(RslRlOnPolicyRunnerCfg):
    class_name = "OnPolicyRunner"
    num_steps_per_env = 192
    max_iterations = 10000
    save_interval = 100
    experiment_name = "g1_assist_exoskeleton_v2_v6_ppo"
