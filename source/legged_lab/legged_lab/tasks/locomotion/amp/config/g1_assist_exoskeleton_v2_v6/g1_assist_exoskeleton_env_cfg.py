...
@configclass
class G1AssistExoskeletonV2V6EnvCfg(G1AssistAmpEnvCfg):
    """Train v2-v6 with -10 Nm lift and +10 Nm press authority."""
    ...
    def __post_init__(self):
        ...
        # Include low forward speeds explicitly in the training distribution.
        self.commands.base_velocity.ranges.lin_vel_x = (0.1, 1.2)
...
@configclass
class G1AssistExoskeletonV2V6EnvCfg_PLAY(G1AssistExoskeletonV2V6EnvCfg):
    """Play configuration for the asymmetric v2-v6 assist policy."""
