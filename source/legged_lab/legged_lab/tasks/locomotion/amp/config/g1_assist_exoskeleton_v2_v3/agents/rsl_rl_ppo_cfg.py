"""PPO for v3: 150 local actor inputs and one signed paired-assist output."""
...
@configclass
class G1AssistExoskeletonV2V3PPORunnerCfg(RslRlOnPolicyRunnerCfg):
    class_name = "OnPolicyRunner"
    num_steps_per_env = 48
    max_iterations = 10000
    save_interval = 100
    experiment_name = "g1_assist_exoskeleton_v2_v3_ppo"
    obs_groups = {"policy": ["policy"], "critic": ["critic"]}
    clip_actions = 1.0

    policy = RslRlPpoActorCriticCfg(
        init_noise_std=0.2,
        # One trainable exploration standard deviation for the signed pair action.
