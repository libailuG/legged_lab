"""v3: v1 body PID actuators, torque assistance, and rear mechanism PD."""
...
from legged_lab.tasks.locomotion.amp.config.g1_assist_v1.robot_cfg import (
    UNITREE_G1_29DOF_ASSIST_V1_CFG,
)
...
# Reuse the frozen gait policy's original PID parameters without changing v1.
UNITREE_G1_29DOF_ASSIST_EXOSKELETON_V2_CFG.actuators = deepcopy(
...
UNITREE_G1_29DOF_ASSIST_EXOSKELETON_V2_CFG.actuators[
    ...
    # the symmetric [-10, +10] Nm command range before writing each effort.
