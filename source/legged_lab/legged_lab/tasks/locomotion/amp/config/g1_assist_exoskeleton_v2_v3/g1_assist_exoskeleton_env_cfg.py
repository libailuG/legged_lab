...
class AssistActionsCfg:
    """One signed policy action commands equal/opposite torques with shared slew limiting."""
...
class AssistRewardsCfg:
    ...
    assist_supported_lift_tracking = RewTerm(
        func=mdp.SupportAwareAssistReward,
        weight=-8.0,
        params={
            **SUPPORT_REWARD_PARAMS,
...
@configclass
class G1AssistExoskeletonV2V3EnvCfg(G1AssistAmpEnvCfg):
    """Train v2-v3 with -10 Nm lift and +10 Nm press authority."""
...
@configclass
class G1AssistExoskeletonV2V3EnvCfg_PLAY(G1AssistExoskeletonV2V3EnvCfg):
    """Play configuration for the asymmetric v2-v3 assist policy."""
