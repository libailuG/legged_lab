#!/usr/bin/env python3
"""Generate standalone C99 source/header for the fixed v7 assist policy."""
...
def main() -> None:
    ...
    if manifest["control"] != expected:
        raise ValueError("C template requires the verified v7 control parameters")
    ...
    header = """/* Generated fixed-weight v7 assist policy; C99, no heap or file I/O. */
...
"""
    ...
    header_path = output_dir / "g1_assist_v7_policy.h"
    source_path = output_dir / "g1_assist_v7_policy.c"
