...
from numpy_assist_policy import NumpyAssistPolicy, V2AssistController
...
DEFAULT_TORCH_POLICY = (
    ...
    "2026-09-02_10-00-19_dynamics_tracking_w8/exported/policy.pt"
)
...
def main() -> None:
    ...
    for _ in range(20):
        ...
        full_motor = full.step(position, velocity)
        half_motor = half.step(position, velocity)
