 ...
 *    最大变化限制为0.4 Nm，即40 Nm/s。apply_output_scale只在最后写电机前
 ...
 *              observation, previous_smoothed_nm, smoothed_nm, &workspace);
 *
 *          // 历史保存未缩放的平滑策略力矩。
