# G1 assist-exoskeleton v2 Sim2Real

本目录对应当前策略：

`logs/rsl_rl/g1_assist_exoskeleton_v2_ppo/2026-09-02_10-00-19_dynamics_tracking_w8/model_1999.pt`
...
- 平滑：每个策略周期最多变化 0.4 Nm，对应 40 Nm/s。
- 左右顺序：始终为 `[left, right]`。
...
policy、obs、历史或 40 Nm/s 平滑过程；最终输出仍限幅在 ±8 Nm。
...
gcc -std=c99 -O2 controller.c \
  sim2real/g1_assist_exoskeleton_v2/c/g1_assist_v2_policy.c -lm
```
...
3. 调用 `g1_assist_v2_policy_step()` 得到经过 40 Nm/s 平滑的策略力矩。
