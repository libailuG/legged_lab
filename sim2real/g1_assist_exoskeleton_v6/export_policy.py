"""Export verified v6 actor and its training control configuration for NumPy deployment."""
import argparse
import hashlib
import json
...
DEFAULT_RUN = ROOT / 'logs/rsl_rl/g1_assist_exoskeleton_v2_v6_ppo/2026-09-09_14-00-18_stronger_support'
...
def main():
    ...
    if control['dt'] != .01 or control['torque_limit'] != 10 or int(cfg['observations']['policy']['history_length']) != 25:
        raise ValueError('Expected v6 100 Hz / 25 frames / +/-10 Nm')
