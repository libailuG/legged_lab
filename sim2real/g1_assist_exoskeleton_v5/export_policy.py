"""Export verified v5 actor and its training control configuration for NumPy deployment."""
import argparse
import hashlib
import json
...
DEFAULT_RUN = ROOT / 'logs/rsl_rl/g1_assist_exoskeleton_v2_v5_ppo/2026-09-09_09-24-28_pulse_credit_fix_1024'
...
def main():
    ...
    if control['dt'] != .01 or control['torque_limit'] != 10 or int(cfg['observations']['policy']['history_length']) != 25:
        raise ValueError('Expected v5 100 Hz / 25 frames / +/-10 Nm')
