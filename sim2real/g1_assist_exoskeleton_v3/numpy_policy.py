#!/usr/bin/env python3
"""Pure NumPy inference and deployment-state handling for the v3 assist policy."""
...
class NumpyAssistPolicy:
    """Float32 v3 MLP with no PyTorch dependency."""
    ...
    def _validate(self) -> None:
        expected_weights = ((256, 150), (64, 256), (16, 64), (1, 16))
